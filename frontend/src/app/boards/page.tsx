...
const Page = () => {
  ...
  const boardDeleted = searchParams.get('boardDeleted') === 'true';
          ...
          {boardDeleted && (
            <>
              <div className="flex flex-col items-center w-full gap-1">
                <span className="text-danger text-lg font-semibold">The Board you were viewing has been deleted by the owner.</span>
              </div>
